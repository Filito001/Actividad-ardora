...
function do_responsivePC() {$("#contedorTotal").width("950px");$("#ArdoraIframe").height("450px");$("#contedorTotal").css("transform-origin", "0 0");$("#contedorTotal").css("transform", "scale(1)");
